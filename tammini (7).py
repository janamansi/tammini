...
def questionnaire():
    ...
    q5 = st.text_area("س5: ھل أدت اﻷﻋراض اﻟﺗﻲ ﻣررت ﺑﮭﺎ إﻟﻰ ﺷﻌورك ﺑﺿﯾق ﻧﻔﺳﻲ ﺷدﯾد أو إﻟﻰ ﺗﻌطﯾل واﺿﺢ ﻟﻘدرﺗك ﻋﻠﻰ أداء ﻣﮭﺎﻣك اﻟﯾوﻣﯾﺔ، ﺳواء ﻓﻲ ﺣﯾﺎﺗك اﻻﺟﺗﻣﺎﻋﯾﺔ، اﻟوظﯾﻔﯾﺔ، أو اﻟﺷﺧﺻﯾﺔ؟ ﻛﯾف ﻻﺣظت ﺗﺄﺛﯾر ذﻟك ﻋﻠﻳك وﻋﻠﻰ ﺗﻔﺎﻋﻼﺗك ﻣﻊ ﻣن ﺣوﻟك؟")
    ...
    if st.button("إرسال التقييم"):
        ...
        if user:
            ...
            expected_headers = [
                ...
                q1.split(':')[0] + ": " + q1.split(': ')[1],
                q2.split(':')[0] + ": " + q2.split(': ')[1],
                q3.split(':')[0] + ": " + q3.split(': ')[1],
                q4.split(':')[0] + ": " + q4.split(': ')[1],
                q5.split(':')[0] + ": " + q5.split(': ')[1],
                q6.split(':')[0] + ": " + q6.split(': ')[1]
            ]
